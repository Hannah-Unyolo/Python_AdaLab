...
account=Account(12345678,1234,"Hannah Unyolo","Nairobi",265888863338)
...
print(account.change_owner_details(1234,"Konemi Unyolo","Malawi",265884944340))
print(account.account_statement(1134))
print(account.set_overdraft_limit(1224,50000))
print(account.calculate_interest(1244,1000))
print(account.freeze_account(1334))
print(account.unfreeze_account(1244))
print(account.set_minimum_balance(1334,500))
print(account.transfer_funds(1224,23456789,3000))
print(account.close_account(1224))